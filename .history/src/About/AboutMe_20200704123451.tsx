      ...
      <Paper elevation={8} className={classes.about}>
        ...
        <div className={classes.aboutP}>
          <Typography variant="body1" component="p">
            ...
            added. I was a mechanic for 9 years with a passion for both cars,
            and computers. This passion drew me towards becoming a certified
            tuner for high performance applications and soon after, I realized
            my passion for software development. As I completed my courses at Coding Dojo, I immedietely  
