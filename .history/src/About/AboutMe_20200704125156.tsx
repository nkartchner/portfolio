      ...
      <Paper elevation={8} className={classes.about}>
        ...
        <div className={classes.aboutP}>
          <Typography variant="body1" component="p">
            ...
            automotive industry. I've been able to apply my 9 years of knowledge
            in the industry to create a real-time production workflow management
            application, Repairsage. You can read more about and demo Repairsage
            in my {projects} page. Shortly after I graduating, I joined the
            Coding Dojo team as a Lead Instructor where I taught students as
            well as contributing to the upkeep of the curriculum and
            collaborating with a small team to write a full MERN stack
            curriculum.
          </Typography>
        </div>
      </Paper>
