...
const MyProjects: IProps[] = [
  {
    ...
    longDesc: (
      <Typography variant="body1" component="p">
        Repairsage SocketIO is used to accomplish real-time updates for every
        board while using rooms to keep each board separate. One of the most
        important features of Repairsage is the ability to assign a technician
        to a column and an efficiency rating that will visually show, based on a
        40 hour their column the appropriate color. work week, the technicians
        workload by changing the numbers in their assigned column. We currently
        have an instance of Repairsage launched that we use as a demo. Feel free
        to check it out!
      </Typography>
    ),
    inProgress: true,
